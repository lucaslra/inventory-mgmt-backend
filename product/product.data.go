...
func searchForProductData(productFilter ProductReportFilter) ([]Product, error) {
	...
	for results.Next() {
		var product Product
		_ = results.Scan(&product.ProductID,
...
func getProduct(productId int) (*Product, error) {
	...
	product := &Product{}
	err := row.Scan(&product.ProductID, &product.Manufacturer, &product.Sku, &product.Upc,
...
func getProductList() ([]Product, error) {
	...
	for results.Next() {
		var product Product
		_ = results.Scan(&product.ProductID, &product.Manufacturer, &product.Sku, &product.Upc,
			&product.PricePerUnit, &product.QuantityOnHand, &product.ProductName)
		products = append(products, product)
	}
	return products, nil
